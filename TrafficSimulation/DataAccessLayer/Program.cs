...
namespace DataAccessLayer
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Trace.TraceInformation("DataAccessLayer: installed factories.");

            // read definitions: positions, edges, agents and rules.
            ...
            Trace.TraceInformation("DataAccessLayer: read definitions.");
            ...
            Trace.TraceInformation("DataAccessLayer: 1st checks done");


            // start Server?
            string pipename = "DataAccess-pipe";
            Console.WriteLine("Pipe-Server {0} ready for connections...", pipename);
            using (NamedPipeServerStream namedPipeServer = new NamedPipeServerStream(pipename, PipeDirection.InOut,
        1, PipeTransmissionMode.Message))
            {
                ...
                } while (String.Compare(messageBuilder.ToString(), "ende") != 0);
