# PositionModel.YScaleFactor Property 
 

Current y-scale factor of the map compared with the initial value is for resizing the point on the map after the windowsize is changed
