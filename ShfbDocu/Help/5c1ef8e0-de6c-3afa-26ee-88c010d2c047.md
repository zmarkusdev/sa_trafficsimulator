# SignModel.YScaleFactor Property 
 

Current y-scale factor of the map compared with the initial value is for resizing the sign on the map after the windowsize is changed
