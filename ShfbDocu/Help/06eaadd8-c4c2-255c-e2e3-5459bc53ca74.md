# AgentModel.XScaleFactor Property 
 

Current x-scale factor of the map compared with the initial value is for resizing the agents on the map after the windowsize is changed
